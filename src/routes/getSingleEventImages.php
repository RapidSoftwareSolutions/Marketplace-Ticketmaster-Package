<?php
$app->post('/api/Ticketmaster/getSingleEventImages', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'].'discovery/v2/events/'.$post_data['args']['eventId'].'/images.json';
    $body = array();
